...
class CandidateTeamMemberAdapter(private val itemHeight: Int = 100.dp) :
    ...
    inner class CandidateTeamMemberViewHolder(private val binding: ItemCandidateTeamMemberBinding) :
        ...
        fun bind(user: User) {
            binding.ivCandidateTeamMember.layoutParams.width = itemHeight

            Glide.with(binding.ivCandidateTeamMember.context)
                .load("https://firebasestorage.googleapis.com/v0/b/partee-1ba05.appspot.com/o/users%2F${user.profileImg}?alt=media")
                .into(binding.ivCandidateTeamMember)

            binding.ivCandidateTeamMember.setOnDebounceClickListener {
